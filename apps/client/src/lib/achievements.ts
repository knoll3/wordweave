...
const GROUPS: GroupDefinition[] = [
  ...
  {
    id: "pokemon-deep-cuts",
    categoryId: "pokemon",
    title: "More Pokemon",
    summary: "A wider bench of favorites, legends, and instantly recognizable picks.",
  },
  {
    id: "myth-icons",
    categoryId: "myth",
  ...
  },
  {
    ...
    summary: "Famous Harry Potter spells that feel great when they finally click.",
  },
  {
    id: "beast-icons",
    categoryId: "beasts",
...
const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  },
  {
    ...
    title: "Discover Bulbasaur",
    description: "Land one of the original starters.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["bulbasaur"] },
  },
  {
    id: "pokemon-squirtle",
    title: "Discover Squirtle",
    description: "Find another all-timer from the first wave.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["squirtle"] },
  },
  {
    id: "pokemon-jigglypuff",
    title: "Discover Jigglypuff",
    description: "Pick up a pink icon with instant recognition.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["jigglypuff"] },
  },
  {
    id: "pokemon-meowth",
    title: "Discover Meowth",
    description: "Catch a familiar troublemaker.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["meowth"] },
  },
  {
    id: "pokemon-psyduck",
    title: "Discover Psyduck",
    description: "Land a goofy fan favorite.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["psyduck"] },
  },
  {
    id: "pokemon-gyarados",
    title: "Discover Gyarados",
    description: "Find a classic powerhouse.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 10,
    requirement: { count: 1, targets: ["gyarados"] },
  },
  {
    id: "pokemon-lapras",
    title: "Discover Lapras",
    description: "Add a beloved sea-travel staple.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["lapras"] },
  },
  {
    id: "pokemon-dragonite",
    title: "Discover Dragonite",
    description: "Track down one of the most recognizable dragons in the series.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 10,
    requirement: { count: 1, targets: ["dragonite"] },
  },
  {
    id: "pokemon-gengar",
    title: "Discover Gengar",
    description: "Land a spooky mainstay.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["gengar"] },
  },
  {
    id: "pokemon-lugia",
    title: "Discover Lugia",
    description: "Bring in a legendary with serious presence.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 10,
    requirement: { count: 1, targets: ["lugia"] },
  },
  {
    id: "pokemon-rayquaza",
    title: "Discover Rayquaza",
    description: "Add a towering legend to the journal.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 10,
    requirement: { count: 1, targets: ["rayquaza"] },
  },
  {
    id: "pokemon-lucario",
    title: "Discover Lucario",
    description: "Find a modern fan favorite with instant silhouette recognition.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["lucario"] },
  },
  {
    id: "pokemon-greninja",
    title: "Discover Greninja",
    description: "Land a sleek standout from a later generation.",
    categoryId: "pokemon",
    groupId: "pokemon-deep-cuts",
    points: 5,
    requirement: { count: 1, targets: ["greninja"] },
  },
  {
    id: "myth-excalibur",
  ...
  {
    id: "screen-lumos",
    title: "Discover Lumos",
    description: "Cast the simplest spell and still earn a real wizarding win.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 5,
    requirement: { count: 1, targets: ["lumos"] },
  },
  {
    id: "screen-accio",
    title: "Discover Accio",
    description: "Summon one of the most useful spells in the series.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 5,
    requirement: { count: 1, targets: ["accio"] },
  },
  {
    id: "screen-alohomora",
    title: "Discover Alohomora",
    description: "Unlock a classic spell by name.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 5,
    requirement: { count: 1, targets: ["alohomora"] },
  },
  {
    id: "screen-expelliarmus",
    title: "Discover Expelliarmus",
    description: "Find one of the most recognizable dueling spells around.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 10,
    requirement: { count: 1, targets: ["expelliarmus"] },
  },
  {
    id: "screen-expecto-patronum",
    title: "Discover Expecto Patronum",
    description: "Land a spell that instantly signals Harry Potter.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 10,
    requirement: { count: 1, targets: ["expecto patronum"] },
  },
  {
    id: "screen-wingardium-leviosa",
    title: "Discover Wingardium Leviosa",
    description: "Add one of the earliest and most famous classroom spells.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 10,
    requirement: { count: 1, targets: ["wingardium leviosa"] },
  },
  {
    id: "screen-stupefy",
    title: "Discover Stupefy",
    description: "Bring a staple combat spell into the journal.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 5,
    requirement: { count: 1, targets: ["stupefy"] },
  },
  {
    id: "screen-reducto",
    title: "Discover Reducto",
    description: "Hit a destructive spell with sharp recognition.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 5,
    requirement: { count: 1, targets: ["reducto"] },
  },
  {
    id: "screen-crucio",
    title: "Discover Crucio",
    description: "Track down one of the darkest spell names in the series.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 10,
    requirement: { count: 1, targets: ["crucio"] },
  },
  {
    id: "screen-imperio",
    title: "Discover Imperio",
    description: "Add another notorious spell to the list.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 10,
    requirement: { count: 1, targets: ["imperio"] },
  },
  {
    id: "screen-avada-kedavra",
    title: "Discover Avada Kedavra",
    description: "Land one of the most infamous spell names in fantasy.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 10,
    requirement: { count: 1, targets: ["avada kedavra"] },
  },
  {
    id: "screen-sectumsempra",
    title: "Discover Sectumsempra",
    description: "Find a spell that feels deep enough to be a flex.",
    categoryId: "screen",
    groupId: "screen-spells",
    points: 10,
    requirement: { count: 1, targets: ["sectumsempra"] },
  },
  {
    id: "beasts-t-rex",
